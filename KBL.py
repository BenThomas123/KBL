...
# team class
class Team:
    def __init__(self, name, roster, wins, losses, arena, conference, games, rhc, championships, rhc_seasons,
...
class Season:
    ...
    def read_individual_awards(self):
    ...
    def handle_awards(self):
        ...
        print("your MVP is: ", Season1.determine_mvp().name)
        Season1.mvp = Season1.determine_mvp()
        print("your DPOY is: ", Season1.determine_dpoy().name)
        Season1.DPOY = Season1.determine_dpoy()
        print("your OPOY is: ", Season1.determine_opoy().name)
        Season1.opoy = Season1.determine_opoy()
        print("Your scoring champ is: ", Season1.determine_scoring_champion().name)
        Season1.pt = Season1.determine_scoring_champion()
        print("Your assist champ is: ", Season1.determine_assist_champion().name)
        Season1.at = Season1.determine_assist_champion()
        print("Your rebound champ is: ", Season1.determine_rebound_champion().name)
        Season1.rt = Season1.determine_rebound_champion()
        print("Your steals champ is: ", Season1.determine_steal_champion().name)
        Season1.st = Season1.determine_steal_champion()
        print("Your blocks champ is: ", Season1.determine_block_champion().name)
        Season1.bt = Season1.determine_block_champion()
        print("Your contest champ is: ", Season1.determine_contest_champion().name)
        Season1.ct = Season1.determine_contest_champion()
...
class Game:
    ...
    def home_team_offense(self):
        ...
        for i in range(len(self.home_team.roster)):
            ...
            tracker += int(self.home_team.roster[i].shotTendency)
        ...
        shotChance = player.rangeTendency
        Steal = 3
        ...
        if odds < shotChance:
            shotValue = 3
            add = player.Threatening + player.makeAMess
            ...
            if divisor < add + 75:
                ...
                for i in range(len(self.home_team.roster)):
                    ...
                    tracker3 += int(self.home_team.roster[i].playmaking)
            ...
            shotValue = 2
            add = player.consistency + player.zeroToOneHundred + player.highMaintenance
...
# Arenas
seaDogBrewing = Arena("Seadog Brewing")
oneTenGrill = Arena("One Ten Grill")
CountryStore = Arena("Country Store")
Lindys = Arena("Lindy's")
LosAngelesElementary = Arena("East Kingston Elementary")
EastMansCorner = Arena("East Mans corner Farm")

# Teams
boston = Team("Boston", BostonRoster, 0, 0, seaDogBrewing, "East", 0, 0, 0, [], [])
new_york = Team("NewYork", NewYorkRoster, 0, 0, oneTenGrill, "East", 0, 0, 0, [], [])
Miami = Team("Miami", MiamiRoster, 0, 0, CountryStore, "East", 0, 0, 0, [], [])
Phoenix = Team("Phoenix", PhoenixRoster, 0, 0, Lindys, "West", 0, 0, 0, [], [])
LosAngeles = Team("LosAngeles", LosAngelesRoster, 0, 0, LosAngelesElementary, "West", 0, 0, 0, [], [])
Denver = Team("Denver", DenverRoster, 0, 0, EastMansCorner, "West", 0, 0, 0, [], [])
...
Season1.read_individual_awards()
